...
print('ai/km, ei, r_isco/km', ai_0/1.e5, ei_0, r_isco/1.e5)
...
ax.semilogy(tt/P_day, ai/1.e7, alpha=0.8, color='tab:grey')
ax.set_ylabel(r'$a_{\rm in}$ [100 km]')

ax=fig.add_subplot(412)
ax.semilogy(tt/P_day, ei, alpha=0.8, color='tab:grey')
ax.set_ylabel(r'$e_{\rm in}$')

ax=fig.add_subplot(413)
ax.plot(tt/P_day, theta1_SL*180./np.pi, alpha=0.8, label=r'$S_1$', color='tab:grey')
ax.plot(tt/P_day, theta2_SL*180./np.pi, alpha=0.8, label=r'$S_2$', color='tab:olive')
ax.axhline(90., color='tab:red', ls=':', alpha=0.5)
ax.set_ylabel(r'$\theta_{SL}$ [deg]')
ax.legend(loc='upper left')

ax=fig.add_subplot(414)
ax.plot(tt/P_day, theta_SS*180./np.pi, alpha=0.8, color='tab:grey')
