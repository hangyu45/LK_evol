...
fig_dir = '/home/hang.yu/public_html/astro/LK_evol/LK2merger/fix_init_spin_ang/SA/M3_%.1eMs_ao_%.3fpc_ai0_%.1fAU/'\
            %(M3, ao, ai_0)
data_dir = 'data/fix_init_spin_ang/SA/M3_%.1eMs_ao_%.3fpc_ai0_%.1fAU/'\
            %(M3, ao, ai_0)
